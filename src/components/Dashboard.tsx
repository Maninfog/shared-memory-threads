  ...
  return <section className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          return <Card key={group.id} className="bg-gray-900 border-gray-800 hover:bg-gray-800 transition-all duration-200 cursor-pointer transform hover:scale-105" onClick={() => onGroupSelect(group.id)}>
